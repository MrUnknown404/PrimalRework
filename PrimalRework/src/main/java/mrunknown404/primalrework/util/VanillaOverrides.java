...
public class VanillaOverrides {
	...
	private static void registerBlocks() {
		...
		HarvestHelper.setHarvestLevel(Blocks.LAPIS_ORE,                     EnumToolType.pickaxe, EnumToolMaterial.copper);
		...
		HarvestHelper.setHarvestLevel(Blocks.REDSTONE_ORE,                  EnumToolType.pickaxe, EnumToolMaterial.iron);
		HarvestHelper.setHarvestLevel(Blocks.LIT_REDSTONE_ORE,              EnumToolType.pickaxe, EnumToolMaterial.iron);
		...
		HarvestHelper.setHarvestLevel(Blocks.EMERALD_ORE,                   EnumToolType.pickaxe, EnumToolMaterial.steel);
		...
		HarvestHelper.setHarvestLevel(Blocks.QUARTZ_ORE,                    EnumToolType.pickaxe, EnumToolMaterial.stone);
