...
public class HarvestHelper {
	...
	private static void registerItems() {
		...
		setHarvestLevel(Items.GOLDEN_PICKAXE, EnumToolType.pickaxe, EnumToolMaterial.copper);
		...
		setHarvestLevel(Items.GOLDEN_SHOVEL, EnumToolType.shovel, EnumToolMaterial.copper);
		...
		setHarvestLevel(Items.GOLDEN_AXE, EnumToolType.axe, EnumToolMaterial.copper);
		...
		setHarvestLevel(Items.GOLDEN_SWORD, EnumToolType.sword, EnumToolMaterial.copper);
		...
		setHarvestLevel(Items.GOLDEN_HOE, EnumToolType.hoe, EnumToolMaterial.copper);
