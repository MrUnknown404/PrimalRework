...
public class RecipeTransferMessage implements IMessage, IMessageHandler<RecipeTransferMessage, IMessage> {
	...
	private static void setItems(EntityPlayer player, Map<Integer, Integer> slotIdMap, List<Integer> craftingSlots, List<Integer> inventorySlots, boolean maxTransfer,
			boolean requireCompleteSets) {
