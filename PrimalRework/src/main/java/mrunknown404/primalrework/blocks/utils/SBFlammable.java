...
public class SBFlammable extends StagedBlock {
	...
	protected SBFlammable(String name, Supplier<Stage> stage, int stackSize, ItemGroup tab, Material material, SoundType sound, boolean hasCollision, boolean canOcclude,
			int lightLevel, EnumBlockInfo blockInfo, boolean isRandomTick, int flammability, int fireSpreadSpeed, BlockStateType blockStateType, BlockModelType blockModelType,
	...
	public SBFlammable(String name, Supplier<Stage> stage, Material material, SoundType sound, EnumBlockInfo blockInfo, int flammability, int fireSpreadSpeed, HarvestInfo info,
