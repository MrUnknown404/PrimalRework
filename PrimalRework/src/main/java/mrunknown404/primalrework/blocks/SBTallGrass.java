...
public class SBTallGrass extends StagedBlock {
	public SBTallGrass() {
		super("tall_grass", PRStages.STAGE_0, 64, PRItemGroups.BLOCKS, Material.LEAVES, SoundType.GRASS, false, false, 0, BlockInfo.SOFT_PLANT, false, BlockStateType.normal,
				BlockModelType.none, new HarvestInfo(ToolType.NONE, ToolMaterial.HAND, DropInfo.item(PRItems.PLANT_FIBER, 30)),
