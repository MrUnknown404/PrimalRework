...
public class GuiFirePit extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		fontRenderer.drawString(name, xSize - fontRenderer.getStringWidth(name) - 7, ySize - 94, 16777215);
		fontRenderer.drawString(player.getDisplayName().getUnformattedText(), 8, ySize - 94, 16777215);
	}
