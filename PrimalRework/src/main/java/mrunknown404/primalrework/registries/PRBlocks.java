...
public class PRBlocks {
	...
	//MISC
	public static final RegistryObject<StagedBlock> THATCH = PRRegistry.block(new StagedBlock("thatch", PRStages.STAGE_0, BlockInfo.of(BlockInfo.THATCH), HarvestInfo.HAND, HarvestInfo.KNIFE_MIN));
	...
	public static final RegistryObject<StagedBlock> GROUND_CLAY = PRRegistry.block(new SBGroundItem("clay", BlockInfo.CLAY_GROUND_ITEM, PRItems.CLAY_BALL));
	...
	public static final RegistryObject<StagedBlock> SALT = PRRegistry.block(new StagedBlock("salt_block", PRStages.STAGE_1, BlockInfo.of(BlockInfo.DIRT), new HarvestInfo(ToolType.SHOVEL, ToolMaterial.CLAY, DropInfo.item(PRItems.SALT, 4, 4))));
	...
	public static final RegistryObject<StagedBlock> CHARCOAL_BLOCK = PRRegistry.block(new StagedBlock("charcoal_block", PRStages.STAGE_2, BlockInfo.with(BlockInfo.COAL, Hardness.SOFT_2), HarvestInfo.HAND, HarvestInfo.KNIFE_MIN));
	...
	public static final RegistryObject<StagedBlock> SHORT_GRASS = PRRegistry.block(new SBTallGrass("short", () -> PRBlocks.SHORT_GRASS, Hardness.SOFT_1, Block.box(2, 0, 2, 14, 6, 14)));
	public static final RegistryObject<StagedBlock> MEDIUM_GRASS = PRRegistry.block(new SBTallGrass("medium", () -> PRBlocks.MEDIUM_GRASS, Hardness.SOFT_1, Block.box(2, 0, 2, 14, 9, 14)));
	public static final RegistryObject<StagedBlock> TALL_GRASS = PRRegistry.block(new SBTallGrass("tall", () -> PRBlocks.TALL_GRASS, Hardness.MEDIUM_0, Block.box(2, 0, 2, 14, 13, 14)).useVanillaNamespaceItem());
	
	//SLABS
	public static final RegistryObject<StagedBlock> DIRT_SLAB = PRRegistry.block(new SBSlab("dirt_slab", PRStages.STAGE_0, BlockInfo.of(BlockInfo.DIRT), HarvestInfo.SHOVEL_MIN).useVanillaNamespaceBlock());
	...
	//VANILLA OVERRIDES
	public static final RegistryObject<StagedBlock> DIRT = PRRegistry.block(new StagedBlock("dirt", PRStages.STAGE_0, BlockInfo.of(BlockInfo.DIRT), HarvestInfo.SHOVEL_MIN).usesVanillaNamespaceFull());
	public static final RegistryObject<StagedBlock> GRASS_BLOCK = PRRegistry.block(new SBGrassBlock());
	public static final RegistryObject<StagedBlock> STONE = PRRegistry.block(new StagedBlock("stone", PRStages.STAGE_0, BlockInfo.of(BlockInfo.STONE), BlockStateType.none, BlockModelType.normal, new HarvestInfo(ToolType.PICKAXE, ToolMaterial.CLAY, DropInfo.item(PRItems.ROCK, 2, 4))).usesVanillaNamespaceFull());
	public static final RegistryObject<StagedBlock> COBBLESTONE = PRRegistry.block(new StagedBlock("cobblestone", PRStages.STAGE_0, BlockInfo.of(BlockInfo.STONE), HarvestInfo.PICKAXE_MIN).usesVanillaNamespaceFull());
