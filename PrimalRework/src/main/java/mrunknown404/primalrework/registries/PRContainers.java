...
public class PRContainers {
	public static final RegistryObject<ContainerType<ContainerCampFire>> CAMPFIRE = PRRegistry.container("campfire", () -> IForgeContainerType.create((windowID, inv, data) -> {
