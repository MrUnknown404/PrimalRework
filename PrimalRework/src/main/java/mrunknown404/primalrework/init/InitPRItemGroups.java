...
public class InitPRItemGroups {
	...
	public static final ModItemGroup RAW_PARTS = new ModItemGroup("raw_parts", () -> new ItemStack(InitItems.getRawPart(Metal.COPPER, RawPart.PLATE)));
	public static final ModItemGroup TOOL_PARTS = new ModItemGroup("tool_parts", () -> new ItemStack(InitItems.getToolPart(Metal.COPPER, ToolType.PICKAXE)));
