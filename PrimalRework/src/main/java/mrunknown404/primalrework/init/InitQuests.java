...
public class InitQuests {
	...
	public static final Quest STAGE_0_GET_THATCH =                addQuest(new Quest("get_thatch",                STAGE_0_GET_PLANT_FIBER,           new QuestRequirement(new ItemStack(ModBlocks.THATCH))));
	public static final Quest STAGE_0_GET_PLANT_MESH =            addQuest(new Quest("get_plant_mesh",            STAGE_0_GET_PLANT_FIBER,           new QuestRequirement(new ItemStack(ModItems.PLANT_MESH))));
	...
	public static final Quest STAGE_1_GET_ANIMAL_PELT =           addQuest(new Quest("get_animal_pelt",           STAGE_1_ROOT,                      new QuestRequirement(new ItemStack(ModItems.ANIMAL_PELT))));
	public static final Quest STAGE_1_GET_RAW_HIDE =              addQuest(new Quest("get_raw_hide",              STAGE_1_GET_ANIMAL_PELT,           new QuestRequirement(new ItemStack(ModItems.RAW_HIDE))));
	public static final Quest STAGE_1_GET_FLINT_CRAFTING_HAMMER = addQuest(new Quest("get_flint_crafting_hammer", STAGE_1_ROOT,                      new QuestRequirement(new ItemStack(ModItems.FLINT_CRAFTING_HAMMER))));
	public static final Quest STAGE_1_GET_CRAFTING_STUMP =        addQuest(new Quest("get_crafting_stump",        STAGE_1_GET_FLINT_CRAFTING_HAMMER, new QuestRequirement(new ItemStack(ModBlocks.CRAFTING_STUMP))));
	public static final Quest STAGE_1_GET_FLINT_SHOVEL =          addQuest(new Quest("get_flint_shovel",          STAGE_1_GET_CRAFTING_STUMP,        new QuestRequirement(new ItemStack(ModItems.FLINT_SHOVEL))));
	public static final Quest STAGE_1_GET_FLINT_SAW =             addQuest(new Quest("get_flint_saw",             STAGE_1_GET_CRAFTING_STUMP,        new QuestRequirement(new ItemStack(ModItems.FLINT_SAW))));
	public static final Quest STAGE_1_GET_FLINT_PICKAXE =         addQuest(new Quest("get_flint_pickaxe",         STAGE_1_GET_CRAFTING_STUMP,        new QuestRequirement(new ItemStack(ModItems.FLINT_PICKAXE))));
	public static final Quest STAGE_1_GET_FLINT_HOE =             addQuest(new Quest("get_flint_hoe",             STAGE_1_GET_CRAFTING_STUMP,        new QuestRequirement(new ItemStack(ModItems.FLINT_HOE))));
	public static final Quest STAGE_1_GET_FIRE_STARTER =          addQuest(new Quest("get_fire_starter",          STAGE_1_GET_CRAFTING_STUMP,        new QuestRequirement(new ItemStack(ModItems.FIRE_STARTER))));
	public static final Quest STAGE_1_GET_FIRE_PIT =              addQuest(new Quest("get_fire_pit",              STAGE_1_GET_FIRE_STARTER,          new QuestRequirement(new ItemStack(ModBlocks.FIRE_PIT))));
	public static final Quest STAGE_1_GET_DRYING_TABLE =          addQuest(new Quest("get_drying_table",          STAGE_1_GET_ROPE,                  new QuestRequirement(new ItemStack(ModBlocks.DRYING_TABLE))));
	public static final Quest STAGE_1_GET_DRIED_HIDE =            addQuest(new Quest("get_dried_hide",            STAGE_1_GET_DRYING_TABLE,          new QuestRequirement(new ItemStack(ModItems.DRIED_HIDE))));
	public static final Quest STAGE_1_GET_SALT =                  addQuest(new Quest("get_salt",                  STAGE_1_GET_FLINT_SHOVEL,          new QuestRequirement(new ItemStack(ModItems.SALT))));
	public static final Quest STAGE_1_GET_PRIMAL_TORCH_LIT =      addQuest(new Quest("get_primal_torch_lit",      STAGE_1_GET_FIRE_PIT,              new QuestRequirement(new ItemStack(ModBlocks.LIT_PRIMAL_TORCH))));
	...
	public static final Quest STAGE_1_GET_MORTAR_PESTLE =         addQuest(new Quest("get_mortar_pestle",         STAGE_1_GET_PLANK,                 new QuestRequirement(new ItemStack(ModItems.MORTAR_PESTLE))));
	public static final Quest STAGE_1_GET_LOOM =                  addQuest(new Quest("get_loom",                  STAGE_1_GET_PLANK,                 new QuestRequirement(new ItemStack(ModBlocks.LOOM))));
	public static final Quest STAGE_1_GET_CLOTH =                 addQuest(new Quest("get_cloth",                 STAGE_1_GET_LOOM,                  new QuestRequirement(new ItemStack(ModItems.CLOTH))));
	public static final Quest STAGE_1_GET_CLAY_POT =              addQuest(new Quest("get_clay_pot",              STAGE_1_GET_FLINT_SHOVEL,          new QuestRequirement(new ItemStack(ModBlocks.CLAY_POT))));
	public static final Quest STAGE_1_GET_CLAY_BUCKET =           addQuest(new Quest("get_clay_bucket",           STAGE_1_GET_FLINT_SHOVEL,          new QuestRequirement(new ItemStack(ModItems.CLAY_BUCKET_EMPTY))));
	...
	public static final Quest STAGE_1_GET_DOUGH =                 addQuest(new Quest("get_dough",                 STAGE_1_GET_MORTAR_PESTLE,         new QuestRequirement(new ItemStack(ModItems.DOUGH))));
