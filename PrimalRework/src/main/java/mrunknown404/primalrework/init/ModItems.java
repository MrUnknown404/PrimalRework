...
public class ModItems {
	...
	//TODO add clay, add shears, leather strips, cooked fish/carrots/etc
	...
	// TOOL HEADS
	public static final Item STONE_PICKAXE_HEAD = new ItemBase("stone_pickaxe_head", 1, EnumStage.stage1);
	public static final Item STONE_AXE_HEAD = new ItemBase("stone_axe_head", 1, EnumStage.stage1);
	public static final Item STONE_SHOVEL_HEAD = new ItemBase("stone_shovel_head", 1, EnumStage.stage1);
	public static final Item STONE_SWORD_HEAD = new ItemBase("stone_sword_head", 1, EnumStage.stage1);
	public static final Item STONE_KNIFE_HEAD = new ItemBase("stone_knife_head", 1, EnumStage.stage1);
	public static final Item STONE_HOE_HEAD = new ItemBase("stone_hoe_head", 1, EnumStage.stage1);
	...
	public static final Item STONE_KNIFE = new ItemToolBase("stone_knife", EnumToolType.knife, EnumToolMaterial.stone, EnumStage.stage1);
	...
	public static final Item STONE_AXE = new ItemToolBase("stone_axe", EnumToolType.axe, EnumToolMaterial.stone, EnumStage.stage1).setCreativeTab(CreativeTabs.TOOLS);
	...
	public static final Item STONE_HOE = new ItemToolBase("stone_hoe", EnumToolType.hoe, EnumToolMaterial.stone, EnumStage.stage1).setCreativeTab(CreativeTabs.TOOLS);
